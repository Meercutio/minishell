...
int stat(const char *FNAME, struct stat *STATISTICS), int fstat (int FD, struct stat *STATISTICS) и int lstat (const char *FNAME, struct stat *STATISTICS)
...
int dup(int file_descriptor) и int dup2 (int FD1, int FD2)
